...
class mock {
    ...
    public function cn_name()
    {
        ...
        $first_name  = $xing_data[mt_rand(0, count($xing_data)-1)];
        $middle_name = $ming_data[mt_rand(0, count($ming_data)-1)];
        $last_name   = $ming_data[mt_rand(0, count($ming_data)-1)];
        ...
        switch ($type) {
            ...
            case 'name':
                ...
                $data = array(
                    ...
                    '华为 Mate 9 Pro 4GB+64GB版 琥珀金 移动联通电信4G手机 双卡双待',
                    '三星 Galaxy C5 Pro（C5010）4GB+64GB版 墨玉黑 移动联通电信4G手机 双卡双待',
                    '魅族 魅蓝 6 全网通公开版 2GB+16GB 磨砂黑 移动联通电信4G手机 双卡双待',
                    'Fitbit Charge 2 智能时尚心率手环 心率实时监测 自动睡眠记录 来电显示 VO2Max测量 黑色L',
                    '华硕（ASUS）RT-AC5300 5300M AC 三频千兆 低辐射 智能无线路由 吃鸡路由',
                    '联想(Lenovo)天逸310标配版 14英寸笔记本电脑（I5-7200U 4G 500G 2G独显 DVD 正版Office2016)黑',
                    '海信（Hisense）大1匹 白富美 节能冷暖 直流变频 空调挂机（KFR-26GW/EF19A3(1Q01)）',
                    'FeiyuTech 【秒杀用券减100元】飞宇SPG手持稳定器 手机云台三轴蓝牙直播运动 SPG 三轴双用手机稳定器',
                    '爱奇艺VR眼镜 小阅悦S 虚拟现实智能眼镜3D头盔 奇遇VR',
                    '华为（HUAWEI）B3智能手环 运动计步蓝牙通话男女手表 B2升级版 领券-摩卡棕-选商务版 商务版',
                    '诺伊曼乳胶宿舍床垫子榻榻米单人床褥垫1.8米床 天然乳胶床垫4cm 90cm*190cm',
                );
                break;
            ...
            case 'desc':
                ...
                $data = array(
                    ...
                    '限量领券立减300！成交价4099',
                    '【拯救者全新升级，外观更炫酷，色彩更丰富】【靠谱之选】天逸性能 稳定高效 使用流畅 商务稳重',
                    '明星机型，快速制热，双模变频省电能手，精美弧线彰显奢华品质',
                    '秒杀449元！买就送伸缩搁脚 或 抱枕 或 超大鼠标垫~165度可躺+京东配送+送货上门',
                    '全球首款 阿里智能 送货上楼 包安装',
                    '碟刹制动 铝合金车架 K架设计 名不虚传',
                    '美国大牌 送大礼包 送视频 教练指导',
                    '“嗨够11.11，好物提前购”购买自营成人奶粉享受低至5折优惠！更多爆款商品，提前享受11.11优惠，早吃早买早享受！',
                    '清新兰香，清甜多汁，高花青素！',
                );
                break;
